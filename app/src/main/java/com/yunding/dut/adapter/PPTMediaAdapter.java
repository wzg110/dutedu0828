...
/**
 * 类 名 称：PPTMediaAdapter
 * <P/>描    述：ppt中媒体列表显示adapter
 * <P/>创 建 人：CM
 * <P/>创建时间：2017/8/15 10:08
 * <P/>修 改 人：CM
 * <P/>修改时间：2017/8/15 10:08
 * <P/>修改备注：
 * <P/>版    本：
 */

public class PPTMediaAdapter extends BaseAdapter{
    private List<PPTResp.DataBean.slideFilesBean>mDataList;
    private Context mContext;
    public PPTMediaAdapter(List<PPTResp.DataBean.slideFilesBean> dataList, Context context){
