...
public class FastBlurUtil {
    ...
    public static String GetUrlBitmap(String url, int scaleRatio, Context context) {
...
//                    false);
//            Bitmap ssss=adjustTone(scaledBitmap,8);
//            Bitmap blurBitmap = blur(context,scaledBitmap, blurRadius);

            String userheadBg= BitmapUtils.saveBitmap(context,originBitmap);
            DUTApplication.getUserInfo().setUserHeadBg(userheadBg);
            return userheadBg;
        } catch (IOException e) {
            e.printStackTrace();
            return null;
