...
/**
 * 类 名 称：PPTQuestionEnumerateSelfFragment
 * <P/>描    述：PPT自学 枚举
 * <P/>创 建 人：CM
 * <P/>创建时间：2017/8/15 17:29
 * <P/>修 改 人：CM
 * <P/>修改时间：2017/8/15 17:29
 * <P/>修改备注：
 * <P/>版    本：
 */

public class PPTQuestionEnumerateSelfFragment extends BackHandledFragment implements IPPTContentView {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(et_notes.getText().toString().trim())) {
                    ...
                    mPresenter.sendFeedBack(mPPTInfoItem.getTeachingId(), mPPTInfoItem.getSlideId()
                            , mPPTQuestionBean.getQuestionId(), mPPTInfoItem.getClassId(), mPPTInfoItem.getSelfTaughtId() + "", et_notes.getText().toString().trim());
                    dialog.dismiss();
                }
            }
        });
