...
public class PPTQuestionInputSelfFragment extends BackHandledFragment implements IPPTContentView {
...
//    ScrollView scrollview;
    ...
    protected int getLayoutId() {
        return R.layout.fragment_question_input_self_fragment;
    }
        ...
        if (mPPTInfoItem.getSlideQuestions().size() > (mQuestionIndex + 1)) {
            ...
            switch (bean.getQuestionType()) {
                ...
                case PPTActivity.TYPE_INPUT:
                    PPTQuestionInputSelfFragment qif = new PPTQuestionInputSelfFragment();
