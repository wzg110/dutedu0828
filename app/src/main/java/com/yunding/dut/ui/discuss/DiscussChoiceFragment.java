...
/**
 * 类 名 称：DiscussChoiceFragment
 * <P/>描    述： 讨论组选择题
 * <P/>创 建 人：CM
 * <P/>创建时间：2017/8/15 11:51
 * <P/>修 改 人：CM
 * <P/>修改时间：2017/8/15 11:51
 * <P/>修改备注：
 * <P/>版    本：
 */
...
public class DiscussChoiceFragment extends BaseFragmentInReading implements IDiscussQuestionView {
    ...
    protected void initView(View view, Bundle saveInstanceState) {
        ...
        tvTitle.setText("单选" + (1 + mQuestionIndex) + "/" + mDataQuestionList.size());
    ...
    public class singleChoiceAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (mDiscussInfo.getState() == 0 || mDiscussInfo.getState() == 3) {
                ...
                //结束
                if (mDataQuestionItem.getStudentAnswer().contains(mDataList[position])) {
