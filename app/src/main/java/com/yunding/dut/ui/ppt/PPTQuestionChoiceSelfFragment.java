...
/**
 * 类 名 称：PPTQuestionChoiceSelfFragment
 * <P/>描    述：PPT自学 单选
 * <P/>创 建 人：CM
 * <P/>创建时间：2017/8/15 17:36
 * <P/>修 改 人：CM
 * <P/>修改时间：2017/8/15 17:36
 * <P/>修改备注：
 * <P/>版    本：
 */

public class PPTQuestionChoiceSelfFragment extends BackHandledFragment implements IPPTContentView {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_question_choice_self_fragment;
    }
    ...
    protected void initView(View view, Bundle saveInstanceState) {
        ...
        tvQuestionCount.setText("单选" + (mQuestionIndex + 1) + "/" + quesionQuantity);
            ...
            case R.id.btn_commit:
                ...
                if (multiChoice.isEmpty()) {
                    ...
                    if (studyMode.equals("2")) {
                        ...
                        if (mPPTQuestionBean.getRightAnswer().equals(userAnswer)) {
