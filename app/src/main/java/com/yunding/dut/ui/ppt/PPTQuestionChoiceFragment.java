...
/**
 * 类 名 称：PPTQuestionChoiceFragment
 * <P/>描    述：PPT课堂单选
 * <P/>创 建 人：CM
 * <P/>创建时间：2017/8/15 17:20
 * <P/>修 改 人：CM
 * <P/>修改时间：2017/8/15 17:20
 * <P/>修改备注：
 * <P/>版    本：
 */

public class PPTQuestionChoiceFragment extends BackHandledFragment
...
//                             最后一页ppt
    ...
    public void getPollingPPTQuestion(List<? extends PPTResp.DataBean.slideQuestionsBean> dataList) {
        if (dataList == null || dataList.size() == 0) {
            ...
            mPPTInfo.set(pptIndex - 1, mPPTInfoItem);
            tvQuestionCount.setText("单选" + (mQuestionIndex + 1) + "/" + (quesionQuantity + dataList.size()));
