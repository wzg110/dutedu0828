...
public class PPTQuestionInputTeacherNewFragment extends BaseFragmentInReading {
    ...
    protected int getLayoutId() {
        return R.layout.fragemnt_ppt_question_input_for_teacher_new;
    }
...
//                    et.setLayoutParams(lpq);
                    ...
                    lp = new AbsoluteLayout.LayoutParams(SizeUtils.dp2px(100),
                            SizeUtils.dp2px(30), (int) (aa[0] + SizeUtils.sp2px(14)+10), (int) (aa[1] - getFontHeight(14)));
